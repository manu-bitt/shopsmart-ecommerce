...
const Cart = () => {
    ...
    if (loading && !cart) return <div className="text-center mt-10">Loading...</div>;
                ...
                <div className="mt-12 lg:grid lg:grid-cols-12 lg:items-start lg:gap-x-12 xl:gap-x-16">
                    ...
                    >
                        ...
                        <div className="mt-6">
                            <Link
                                to="/checkout"
                                className="w-full flex justify-center rounded-md border border-transparent bg-indigo-600 px-4 py-3 text-base font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-50"
                            >
                                Checkout
                            </Link>
                        </div>
